...
/**
 * Polisen MCP Server v1.0
 *
 * 1 tool for Swedish police events via Polisen.se.
...
import { formatEvents } from './formatter.js';
...
async function main(): Promise<void> {
  const server = new Server(
    { name: 'Polisen MCP Server', version: '1.0.0' },
  ...
  console.error('Polisen MCP Server running on stdio');
}
